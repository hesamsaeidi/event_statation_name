...
dir_path = '/Users/hesam/AFRICA'
bigList = os.listdir(dir_path)
source = "/Users/hesam/AFRICA/{netwrok_name}/allData.out"
destin = "/Users/hesam/test/db_test/NETWORKS/ALLDATA/{netwrok_name}_allData.out"

for net in bigList:
    if net != "SCRIPTS" and net != ".DS_Store":
            shutil.copy(
                source.format(netwrok_name = net)
                ,
                destin.format(netwrok_name = net)
            )
